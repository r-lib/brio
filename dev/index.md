...
brio also has
[`readLines()`](https://brio.r-lib.org/dev/reference/readLines.md) and
[`writeLines()`](https://brio.r-lib.org/dev/reference/writeLines.md)
functions drop-in replacements for
[`base::readLines()`](https://rdrr.io/r/base/readLines.html) and
[`base::writeLines()`](https://rdrr.io/r/base/writeLines.html). These
functions are thin wrappers around
[`brio::read_lines()`](https://brio.r-lib.org/dev/reference/read_lines.md)
and
[`brio::write_lines()`](https://brio.r-lib.org/dev/reference/write_lines.md),
with deliberately fewer features than the base equivalents. If you want
to convert a package to using brio you can add the following line and
re-document.
