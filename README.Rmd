...
Write speeds are basically the same regardless of method, though brio does avoid any extra memory allocations.
...
Reading speeds are a decent amount faster with brio, mainly due to larger block sizes and avoidance of unnecessary copies.
